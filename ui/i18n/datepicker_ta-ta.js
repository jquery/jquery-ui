...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		define( [ "../widgets/datepicker_ta" ], factory );
	} else {

		// Browser globals
		factory( jQuery.datepicker_ta );
	}
}( function( datepicker_ta ) {

datepicker_ta.regional.ta = {
	closeText: "மூடு",
	prevText: "முன்னையது",
	nextText: "அடுத்தது",
	currentText: "இன்று",
	...
	yearSuffix: "" };
datepicker_ta.setDefaults( datepicker_ta.regional.ta );

return datepicker_ta.regional.ta;
