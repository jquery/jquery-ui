...
$.widget("ui.colorpicker", {
	...
	init: function() {
		...
		tpl = '<div class="ui-colorpicker clearfix"><div class="ui-colorpicker-color"><div><div></div></div></div><div class="ui-colorpicker-hue"><div></div></div><div class="ui-colorpicker-new-color"></div><div class="ui-colorpicker-current-color"></div><label for="ui-colorpicker-hex" title="hex">#</label><div class="ui-colorpicker-hex"><input type="text" maxlength="6" size="6" /></div><label for="ui-colorpicker-rgb-r">R</label><div class="ui-colorpicker-rgb-r ui-colorpicker-field"><input type="text" maxlength="3" size="3" /><span></span></div><label for="ui-colorpicker-rgb-g">G</label><div class="ui-colorpicker-rgb-g ui-colorpicker-field"><input type="text" maxlength="3" size="3" /><span></span></div><label for="ui-colorpicker-rgb-b">B</label><div class="ui-colorpicker-rgb-b ui-colorpicker-field"><input type="text" maxlength="3" size="3" /><span></span></div><label for="ui-colorpicker-hsb-h">H</label><div class="ui-colorpicker-hsb-h ui-colorpicker-field"><input type="text" maxlength="3" size="3" /><span></span></div><label for="ui-colorpicker-hsb-s">S</label><div class="ui-colorpicker-hsb-s ui-colorpicker-field"><input type="text" maxlength="3" size="3" /><span></span></div><label for="ui-colorpicker-hsb-b">B</label><div class="ui-colorpicker-hsb-b ui-colorpicker-field"><input type="text" maxlength="3" size="3" /><span></span></div><button class="ui-colorpicker-submit ui-default-state" name="submit" type="submit">Done</button></div>';
