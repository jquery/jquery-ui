...
test('Check Date Setup', function(){
    ok(true,'First Test Always Passes');
    ok($.date(), 'Load JQuery Date');
});
test('Check Sets and Gets', function(){
    var date = new $.date();
...
test('Date Adjustments - Normal Use Cases', function(){
    var date = new $.date();
    //Use October 15, 2012
...
test('Date Adjustments - Month Overflow Edge Cases', function(){
    var date = new $.date();
    //Use May 31 2012
...
test('Date Adjustments - Leap Year Edge Cases', function(){
    var date = new $.date();
...
test('List days of Week', function(){
    var date = new $.date();
    var offset0 = [
