define( [
	...
	QUnit.test( "maxDateMultMonths-prevButton", function( assert ) {
		...
		assert.equal( $( "div.ui-datepicker-title" ).text(),
			...
			// Support: IE <9, jQuery <1.8
			// In IE7/8 with jQuery <1.8, encoded spaces behave in strange ways
			$( "<span>October&#xa0;2009November&#xa0;2009December&#xa0;2009January&#xa0;2010</span>" ).text(), "Initial month" );
		...
		assert.equal( $( "div.ui-datepicker-title" ).text(),
			...
			// Support: IE <9, jQuery <1.8
			// In IE7/8 with jQuery <1.8, encoded spaces behave in strange ways
			$( "<span>August&#xa0;2009September&#xa0;2009October&#xa0;2009November&#xa0;2009</span>" ).text(), "After prev clicks" );
		...
		assert.equal( $( "div.ui-datepicker-title" ).text(),
			...
			// Support: IE <9, jQuery <1.8
			// In IE7/8 with jQuery <1.8, encoded spaces behave in strange ways
			$( "<span>October&#xa0;2009November&#xa0;2009December&#xa0;2009January&#xa0;2010</span>" ).text(), "After next clicks" );
