...
test("events", function() {
	...
	var dateStr, newMonthYear, inp2,
		inp = datepickerTestHelper.init("#inp", {onSelect: callback}),
	date = new Date();
	// onSelect
	inp.val("").datepicker("show").
		simulate("keydown", {keyCode: $.ui.keyCode.ENTER});
	equal(selectedThis, inp[0], "Callback selected this");
	equal(selectedInst, $.data(inp[0], datepickerTestHelper.PROP_NAME), "Callback selected inst");
	...
	equal(selectedInst, $.data(inp[0], datepickerTestHelper.PROP_NAME), "Callback change month/year inst");
	...
	equal(selectedInst, $.data(inp[0], datepickerTestHelper.PROP_NAME), "Callback close inst");
	...
	inp2 = datepickerTestHelper.init("#inp2");
...
test("beforeShowDay-getDate", function() {
	expect( 3 );
	var inp = datepickerTestHelper.init("#inp", {beforeShowDay: function() { inp.datepicker("getDate"); return [true, ""]; }}),
